...
ValNominale = c(100, 0.5, 0.0014, 0.00029, 0.0019, 0.0019, 0.0082, 5, 1/365, 1/365, 0.3, 1/5, 1/20, 1/100, 0.001, 0.7, 0.0005)

parametres_scena = matrix(data = ValNominale, ncol = 17)
colnames(parametres_scena) <- nom_scenar

modAppli_scenario(parametres_scena)

...
## Documenatation
Voici notre proposition de modification du modèle : Lorsque la proportion de décès dus à la maladie par rapport à l'effectif total de la population devient trop élevée, tous les individus testés positifs sont dirigés vers le compartiment de la "quarantaine". Ce mécanisme s'enclenche uniquement lorsque le nombre de décès attribuables à la maladie parmi les individus infectés dépasse un certain "seuil" de la population totale. Ainsi, tous les individus infectieux testés positifs sont transférés dans le compartiment de la quarantaine, affichant à la fois des taux de mortalité naturelle (m1) identiques à ceux des autres états de santé et des taux de mortalité liés à la maladie (madd) similaires aux infectieux. Enfin, les individus en quarantaine peuvent développer une immunité au bout d'une certaine période (rec).
...
increment = c(1, 0.05, 0.0001, 0.00001, 0.0002, 0.0002,
  0.0003, 0.5, 0.0002, 0.0002, 0.03, 
  0.01, 0.0005, 0.0005, 0.0001,0.01,0.001
)

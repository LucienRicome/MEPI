...
La sortie 1 correspond à la prévalence de la maladie à l'état final des simulations. Cette prévalence est principalement guidée par le coefficient de transmission de la maladie (trans) ainsi que par le temps d'incubation de la maladie (1/loss). La sortie 2 correspond à la valeur de la fonction de transmission de la maladie, ce qui permet de mettre en évidence le caractère épidémique ou endémique de la propagassion de la maladie ***(J'ai pas bien compris cette phrase, pour moi, La fonction de transmission permet de modéliser comment la maladie se propage dans une population)***. Les résultats de l'analyse FAST nous permet de mettre en évidence l'importance du coefficient de transmission et du temps d'incubation de la maladie pour cette sortie. Nottons une sensibilité de cette sortie aux paramètre liés à la natalité des individus.
...
=======
plot(0.1, 0.1, type="n", ylim=c(0, max(sigma$ycol1)+0.1), xlim=c(0, 0.07), xlab="mu.star", ylab="sigma")
>>>>>>> c287338260d930e65012a217c1953fdb67b3ef4a
polygon(x = c(0,0,100), y = c(0,100,0), col = "skyblue", border = NA)
polygon(x = c(0,0,0.1), y = c(0,100,0), col = "yellow", border = NA)
polygon(x = c(0.1,100,0.1), y = c(0,0.1,0.1), col = "orange", border = NA)
points(mu.star$ycol1, sigma$ycol1)
...
=======
plot(0.1, 0.1, type="n", ylim=c(0, max(sigma$ycol2)+0.1), xlim=c(0, 0.30), xlab="mu.star", ylab="sigma")
>>>>>>> c287338260d930e65012a217c1953fdb67b3ef4a
polygon(x = c(0,0,100), y = c(0,100,0), col = "skyblue", border = NA)
polygon(x = c(0,0,0.1), y = c(0,100,0), col = "yellow", border = NA)
polygon(x = c(0.1,100,0.1), y = c(0,0.01,0.01), col = "orange", border = NA)
...
=======
plot(0.1, 0.1, type="n", ylim=c(0, max(sigma$ycol3)+0.1), xlim=c(0, 12), xlab="mu.star", ylab="sigma")
>>>>>>> c287338260d930e65012a217c1953fdb67b3ef4a
polygon(x = c(0,0,100), y = c(0,100,0), col = "skyblue", border = NA)
polygon(x = c(0,0,0.1), y = c(0,100,0), col = "yellow", border = NA)
polygon(x = c(0.1,900,0.1), y = c(0,0,0.1), col = "orange", border = NA)
...
=======
plot(0.1, 0.1, type="n", ylim=c(0, max(sigma$ycol1)+1), xlim=c(0, 90), xlab="mu.star", ylab="sigma")
>>>>>>> c287338260d930e65012a217c1953fdb67b3ef4a
polygon(x = c(0,0,200), y = c(0,100,0), col = "skyblue", border = NA)
polygon(x = c(0,0,0.1), y = c(0,5000,0), col = "yellow", border = NA)
polygon(x = c(0.1,5000,0.1), y = c(0,0,0.1), col = "orange", border = NA)

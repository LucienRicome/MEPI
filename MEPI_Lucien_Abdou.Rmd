...
Les figure ci-dessous représente $\sigma$ en fonction de $\mu^*$ pour chaque paramètre.
...
si
$$ \ N_{I,t}\times madd < seuil \times N_t $$
...
2. Dans le cas où les individus testés positifs sont mis en quanrantaine 
